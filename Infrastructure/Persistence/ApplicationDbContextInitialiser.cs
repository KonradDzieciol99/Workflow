...
namespace Infrastructure.Persistence
{
    public class ApplicationDbContextInitialiser
    {
        ...
        public async Task TrySeedAsync()
        {
            ...
            {
                if (_roleManager.Roles.All(r => r.Name != item.Name))
                {
            ...
            // Default users
            var administrator = new AppUser { UserName = "Admin@gmail.com", Email = "Admin@gmail.com",EmailConfirmed=true};

            if (_userManager.Users.All(u => u.UserName != administrator.UserName))
            {
                await _userManager.CreateAsync(administrator, "Administrator1!");
                await _userManager.AddToRolesAsync(administrator, new[] { "Admin", "Moderator" });
            }
            // Default data
            // Seed, if necessary
