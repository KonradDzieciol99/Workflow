...
public class ProjectMemberUpdatedDomainEventHandler
    : INotificationHandler<ProjectMemberUpdatedDomainEvent>
{
    ...
    public Task Handle(
        ProjectMemberUpdatedDomainEvent notification,
        CancellationToken cancellationToken
    )
    {
        var @event = new ProjectMemberUpdatedEvent(
