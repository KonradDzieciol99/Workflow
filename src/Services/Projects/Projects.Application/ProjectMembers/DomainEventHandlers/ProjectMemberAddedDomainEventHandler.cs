...
public class ProjectMemberAddedDomainEventHandler
    : INotificationHandler<ProjectMemberAddedDomainEvent>
{
    ...
    public Task Handle(
        ProjectMemberAddedDomainEvent notification,
        CancellationToken cancellationToken
    )
    {
        var @event = new ProjectMemberAddedEvent(
            ...
            notification.Member.InvitationStatus,
