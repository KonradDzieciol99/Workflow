...
public class UserOnlineNotifcationsAndUnreadEventHandler
    : IRequestHandler<UserOnlineNotifcationsAndUnreadEvent>
{
    ...
    public async Task Handle(
        UserOnlineNotifcationsAndUnreadEvent request,
    ...
    )
    {
        await _presenceHubContext.Clients
            ...
            .SendAsync(
                ...
                new PagedAppNotifications(request.AppNotifications, request.TotalCount),
                cancellationToken: cancellationToken
            );
        await _presenceHubContext.Clients
            .User(request.OnlineUser.Id)
