...
{
    public class AuthorRequirementHandler : AuthorizationHandler<AuthorRequirement, ProjectMember>
    {
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, AuthorRequirement requirement, ProjectMember resource)
        {
