...
{
    public class ManagementRequirementHandler : AuthorizationHandler<ManagementRequirement, string>
    {
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, ManagementRequirement requirement, string resource)
        {
