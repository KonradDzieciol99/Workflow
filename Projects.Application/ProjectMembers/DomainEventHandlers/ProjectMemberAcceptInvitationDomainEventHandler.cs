...
public class ProjectMemberAcceptInvitationDomainEventHandler : INotificationHandler<ProjectMemberAcceptInvitationDomainEvent>
{
    private readonly IIntegrationEventService _integrationEventService;

    public ProjectMemberAcceptInvitationDomainEventHandler(IIntegrationEventService integrationEventService)
    {
        this._integrationEventService = integrationEventService;
    }
    public Task Handle(ProjectMemberAcceptInvitationDomainEvent notification, CancellationToken cancellationToken)
    {
        var @event = new ProjectMemberAcceptInvitationEvent(notification.Member.Id, notification.Member.UserId,
